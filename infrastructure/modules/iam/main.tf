...
# =============================================================================
# resource "<资源类型>" "<本地名称>" { ... }
#   - "资源类型"（如 aws_iam_role）：由 Provider 定义，告诉 Terraform「我要创建什么」。
#     命名规范：<provider>_<资源名>
#   - "本地名称"（如 app_role）：你自己起的名字，只在当前模块内有效，
#     用于在代码中引用这个资源，如 aws_iam_role.app_role.name
#   - 类比 Java：AwsIamRole appRole = new AwsIamRole();
#     资源类型 ≈ 类名，本地名称 ≈ 变量名
# =============================================================================
