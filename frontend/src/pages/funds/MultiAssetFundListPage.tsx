...
const RISK_LABELS: Record<number, string> = { 1:'Conservative', 2:'Moderately Conservative', 3:'Balanced', 4:'Adventurous', 5:'Speculative' };
...
export default function MultiAssetFundListPage() {
  ...
  return (
    <PageLayout title="Multi-Asset Portfolios" showBack>
      <div className="px-4 py-3 bg-si-light border-b border-si-border">
        <p className="text-xs text-si-gray">5 risk levels · World Selection 1–5</p>
      </div>
      {isLoading ? (
              ...
              <div className="flex justify-between items-start">
                <div className="flex-1 pr-4">
                  ...
                  <p className="text-xs text-si-gray mt-1">
                    Risk Level {fund.riskLevel} · {RISK_LABELS[fund.riskLevel] ?? ''}
                  </p>
                </div>
