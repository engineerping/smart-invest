...
Smart Invest 是一款**小额投资平台**，通过这款软件，银行将诸多用户的小额资金汇集到一起，由专业的基金经理进行管理，用这些资金购买只有大量资金人才有资格购买的高质量基金，然后将利润分配给用户。——本软件以真实银行投资 App 为原型设计。
...
详细内容请参阅：[产品分析与功能范围.md](doc-design/I.产品分析与功能范围.md)
